    ...
    function mc_time_s( mc_measure_path )
        ...
        mc_n = mc_meas(:,1);
        mc_c = mc_meas(:,2);
        mc_t = mc_meas(:,3) + mc_meas(:,4);

        % Estimate model parameter %
        mc_p = [ ( mc_n' .^ 3 ) ./ mc_c'; ( mc_n' .^ 2 ) ./ mc_c'; ( mc_n' ) ./ mc_c'; ( mc_n' .* log( mc_n' ) ) ./ mc_c' ]' \ mc_t;

        % Display parameter %
        printf( 'Estimated parameter : %f %f %f %f\n', mc_p( 1 ), mc_p( 2 ), mc_p( 3 ), mc_p( 4 ) );
        ...
        for mc_xx = 1 : length( mc_x ); for mc_yy = 1 : length( mc_y )
                ...
                % Create function %
                mc_f( mc_xx, mc_yy ) = ( 1 / mc_y( mc_yy ) ) * ( ...

                    mc_p(1) * mc_x( mc_xx ) ^3 + ...
                    mc_p(2) * mc_x( mc_xx ) ^2 + ...
                    mc_p(3) * mc_x( mc_xx )    + ...
                    mc_p(4) * mc_x( mc_xx ) * log( mc_x( mc_xx ) ) ...
        ...
        print( '-depsc', '-F:16', [ '../dev/pubs/LC-MC0415/plots/mc_time_s.eps' ] );
